...
We will later on pool these correlation estimates. In order to get one $\rho_{pulled}$ for each comparison and each outcome: To do so - INTRODUCE log transformation refer to @Borenstein2009 (to VIVE students: Find e-version of this book in our literature folder)
