...
options(pillar.sigfig = 4) # Ensure tibble include 4 digits
options(tibble.width = Inf) # Ensure that all colums are printed 
...
tibble(
  ...
  groups = rep(c("Disease-and-recovery", "Cognitive-behavioral", "Usual group treatment"), 2),
...
gt(rowname_col = "groups", groupname_col = "outcome") |> 
  ...
  tab_stubhead(label = html("Subscale and<br>therapy group"))
