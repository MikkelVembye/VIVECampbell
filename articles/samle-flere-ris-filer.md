...
```
    ...
    ## Rows: 1,000
    ## Columns: 33
    ## $ source_type      <chr> "JOUR", "JOUR", "JOUR", "JOUR", "JOUR", "JOUR", "JOUR…
    ## $ database         <chr> "Embase Preprint", "Embase Preprint", "Embase Preprin…
    ## $ accession_nr     <chr> "2031394640", "2029577544", "2028779392", "2028194569…
    ## $ title            <chr> "Mixed Methods Family Centered Study of Pain Experien…
    ## $ author           <chr> "Kumar J.; Atkinson D.; Chima A.; McLaughlin L.; Pari…
    ## $ AO               <chr> "Chidambaran, Vidya; ORCID: https://orcid.org/0000-00…
    ## $ year             <chr> "2024//", "2023//", "2023//", "2023//", "2023//", "20…
    ## $ abstract         <chr> "Background and Objectives: Although racial dispariti…
    ## $ keywords         <chr> "adult; aged; avoidance behavior; caregiver; *Caucasi…
    ## $ journal_jf       <chr> "medRxiv", "bioRxiv", "medRxiv", "medRxiv", "medRxiv"…
    ## $ journal_ja       <chr> "medRxiv", "bioRxiv", "medRxiv", "medRxiv", "medRxiv"…
    ## $ language         <chr> "English", "English", "English", "English", "English"…
    ## $ start_page       <chr> "", "", "", "", "", "", "6946", "", "", "", "", "", "…
    ## $ address          <chr> "United States", "United States", "United States", "U…
    ## $ address2         <chr> "V. Chidambaran, Department of Anesthesia, Cincinnati…
    ## $ address3         <chr> "(Kumar, Atkinson, Chima, McLaughlin, Parikh, Chidamb…
    ## $ address4         <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
    ## $ publisher        <chr> "medRxiv", "bioRxiv", "medRxiv", "medRxiv", "medRxiv"…
    ## $ url              <chr> "https://www.medrxiv.org/", "https://www.biorxiv.org"…
    ## $ doi              <chr> "https://dx.doi.org/10.1101/2024.03.20.24304546", "ht…
    ## $ publication_type <chr> "Preprint", "Preprint", "Preprint", "Preprint", "Prep…
    ## $ L2               <chr> "http://ovidsp.ovid.com/ovidweb.cgi?T=JS&PAGE=referen…
    ## $ issn             <chr> "", "2692-8205 (electronic); 2692-8205", "", "", "", …
    ## $ journal_t3       <chr> "", "", "", "", "", "", "38th Annual Canadian Associa…
    ## $ volume           <chr> "", "", "", "", "", "", "30", "", "", "", "", "", "",…
    ## $ issue            <chr> "", "", "", "", "", "", "7", "", "", "", "", "", "", …
    ## $ end_page         <chr> "", "", "", "", "", "", "6947", "", "", "", "", "", "…
    ## $ record_id        <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
    ...
    ## $ M2               <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
    ## $ pubmed_id        <chr> "", "", "", "", "", "", "", "", "", "", "", "", "", "…
    ## $ custom3          <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
    ## $ C4               <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, N…
