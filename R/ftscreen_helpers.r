utils::globalVariables(c(
  "decision_binary", "title", "promptid", "prompt", "supplementary", "detailed_description",
  "final_decision_gpt_num", "desc", "n_words_answer", "price_in_per_token", "price_out_per_token",
  "file_path", "file_content", "prompt_tokens", "completion_tokens", "input_price", "output_price",
  "total_price_dollar", "question", "iterations", "input_price_dollar", "output_price_dollar",
  "combination_idx", "rep_num", "current_file_path", "safe_basename", "current_prompt",
  ...
  if (!AIscreenR::is_gpt_tbl(data)){
    ...
    dat <-
      ...
      dplyr::mutate(
        ...
        input_price = prompt_tokens * .input_price(model) * iterations,
      ...
      dplyr::summarise(
        ...
        total_price_dollar = input_price_dollar + output_price_dollar,
